...
public class SMSUtils {
	...
	public static com.aliyun.dysmsapi20170525.Client createClient() throws Exception {
		com.aliyun.teaopenapi.models.Config config = new com.aliyun.teaopenapi.models.Config()
				// 必填，您的 AccessKey ID
				.setAccessKeyId("LTAI5tEcqRWAX6moeoPyofEi")
				// 必填，您的 AccessKey Secret
				.setAccessKeySecret("rJ4OrVD7g7S2f3tGJVj1tdvkHaYwiU");
		// 访问的域名
	...
	public static void sendMessage(String phoneNumbers,String param) throws Exception {
		...
		com.aliyun.dysmsapi20170525.Client client = SMSUtils.createClient("LTAI5tEcqRWAX6moeoPyofEi","rJ4OrVD7g7S2f3tGJVj1tdvkHaYwiU");
