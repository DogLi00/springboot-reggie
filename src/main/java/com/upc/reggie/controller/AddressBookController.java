...
public class AddressBookController {
    ...
    public R<AddressBook> setDefault(@RequestBody AddressBook addressBook) {
        ...
        wrapper.eq(AddressBook::getUserId, ThreadLocalUtils.getCurrentId());
    ...
    public R<AddressBook> getDefault() {
        ...
        queryWrapper.eq(AddressBook::getUserId, ThreadLocalUtils.getCurrentId());
    ...
    @PutMapping
    public R<String> changeAddress(@RequestBody AddressBook addressBook){
